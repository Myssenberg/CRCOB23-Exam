...
def Prover_challenge(g1, g2, h1, h2, a1, a2):
    e = sha256(str(g1+g2+h1+h2+a1+a2).encode()).hexdigest() #Computes random challenge to send to prover
...
def Verifier_verify(g1, g2, z, a1, a2 , h1, h2 , group):
...
def proof():
    ...
    verify = Verifier_verify(g1, g2, response, commitment1, commitment2, h1, h2, group)
